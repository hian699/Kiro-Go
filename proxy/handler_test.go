...
func TestClaudeNonStreamRetriesNextAccountAfterPreResponseFailure(t *testing.T) {
	...
	h.handleClaudeNonStream(rec, payload, payload, "claude-sonnet-4.5", false, claudeThinkingResponseOptions{}, 1, nil, "", [32]byte{}, "")
...
func TestBuildAnthropicModelsResponseGeneratesThinkingVariants(t *testing.T) {
	// Kiro advertises the dot form; /v1/models must expose the dash form.
